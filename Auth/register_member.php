 ...
 <div class="header-dash">
	<div class="container">
		...
		<div class="banner">
          ...
          <p>*Please specify your level of sports knowledge from the scale of 1 to 5</p>
        </br>
									<font face="Montserrat" color="#fff"><b>Level</b></font>
								<input type="text" name="level" id="level" style="
